<template>
  <div>
    ...
    <el-row :gutter="16" style="margin-bottom:16px">
      <el-col :span="24"><ChartCard :title="`${unitName} - 消耗曲线`" :option="lineOption" :height="350" /></el-col>
    </el-row>
...
async function fetchData() {
  ...
  loading.value = true
  try {
    const res = await getUnitStat(query)
    unitName.value = res.data.unit_name
